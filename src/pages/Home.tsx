        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-white/60 text-lg md:text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
              Indulge in a symphony of flavors where luxury meets culinary
              artistry. Discover our curated selection of premium dishes crafted
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-white/50 text-lg mb-10 leading-relaxed">
                From the ambient lighting to the meticulously curated decor,
                every element of Sky8 VIP Lounge is designed to transport you to
                a world of luxury and comfort. Whether it's a romantic dinner or
                a corporate gathering, we provide the perfect backdrop.
              </p>
