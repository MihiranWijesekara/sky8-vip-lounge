        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#d4af37] hover:border-[#d4af37] transition-all">
          ...
          <div>
            <h4 className="text-white font-bold mb-6 uppercase tracking-widest text-sm">Hours</h4>
