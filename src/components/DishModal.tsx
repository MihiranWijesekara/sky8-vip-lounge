          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 flex flex-col">
              ...
              <p className="text-white/50 text-sm mb-8 leading-relaxed">
                {item.desc ||
                  "Our signature dish, prepared with passion and precision. We use only the freshest ingredients sourced from local producers to ensure the highest quality and flavor profile."}
              </p>

              <div className="mb-8">
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#d4af37] block mb-4">
                  Select Size
                </span>
